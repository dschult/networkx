...
class TestVF2GraphDB:
    ...
    def test_subgraph(self):
        ...
        gm = iso.vf2pp(graph, subgraph, "label")
        assert gm._is_induced_subgraph()
        # Just testing some cases
        assert gm._is_subgraph()
    ...
    def test_graph_atlas(self):
        ...
        for graph in Atlas:
            ...
            for s in range(10):
                ...
                gm = iso.vf2pp(graph, relabel, "label")
                assert gm._is_isomorphic()
